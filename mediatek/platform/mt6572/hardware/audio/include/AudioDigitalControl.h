...
class AudioDigitalControl : public AudioDigitalControlInterface
{
	...
	virtual status_t SetMATVDigitalStatus(bool bEnable);  //ting.kang add for TV start
        /**
        * this functionis Get Fm Digital Status
        * @param void
        * @return bool
        */
	virtual bool GetMATVDigitalStatus(void) ;  //ting.kang add for TV end
	...
	bool mMatvDigitalStatus;  //ting.kang add for TV
