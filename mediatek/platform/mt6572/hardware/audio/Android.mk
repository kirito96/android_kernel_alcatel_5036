...
#20130306 ting.kang add for receiver volume too low of MMITtest -start
ifeq ($(strip $(TARGET_BUILD_MMITEST)),true)
  LOCAL_CFLAGS += -DJRD_MMITEST_RECEIVERLOOP
endif
#20130306 ting.kang add for receiver volume too low of MMITtest -end
