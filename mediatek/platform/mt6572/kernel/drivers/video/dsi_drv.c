...
//zrl modify to reduce the esd recovery time begin,130725   
      //static const long WAIT_TIMEOUT = 2 * HZ;    // 2 sec
   	  static const long WAIT_TIMEOUT = 2 * HZ/20;    // 100 ms
//zrl modify to reduce the esd recovery time end,130725   
...
//zrl modify for HX8379a read LCD ID end,130824
      ...
      if (buffer_size < 0x3)
         t0.Data_ID = DSI_DCS_READ_PACKET_ID;
	  	 ...
	  	 t0.Data_ID = DSI_DCS_READ_PACKET_ID; //baoqiang fix display issue
