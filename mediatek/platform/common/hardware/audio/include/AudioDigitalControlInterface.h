...
class AudioDigitalControlInterface
{
    public:
        ...
        * @return status_t
        */
	virtual status_t SetMATVI2SConnectStatus(bool bEnable) = 0;
        virtual status_t SetFmDigitalStatus(bool bEnable) = 0;
	virtual status_t SetMATVDigitalStatus(bool bEnable) = 0;  //ting.kang add for TV
        /**
	...
	virtual bool GetMATVDigitalStatus(void) = 0;  //ting.kang add for TV
		/**
