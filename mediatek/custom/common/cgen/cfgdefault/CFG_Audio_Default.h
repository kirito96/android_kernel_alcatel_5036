...
AUDIO_VER1_CUSTOM_VOLUME_STRUCT audio_ver1_custom_default1 = {
    VER1_AUD_VOLUME_RING1,
    VER1_AUD_VOLUME_SIP1,
    VER1_AUD_VOLUME_MIC1,
    VER1_AUD_VOLUME_FM1,
    VER1_AUD_VOLUME_SPH1,
    VER1_AUD_VOLUME_SPH1, // sph2 now use the same
    VER1_AUD_VOLUME_SID1,
    VER1_AUD_VOLUME_MEDIA1,
    VER1_AUD_VOLUME_MATV1,
    VER1_AUD_NORMAL_VOLUME_DEFAULT1,
    VER1_AUD_HEADSER_VOLUME_DEFAULT1,
    VER1_AUD_SPEAKER_VOLUME_DEFAULT1,
    VER1_AUD_HEADSETSPEAKER_VOLUME_DEFAULT1,
    VER1_AUD_EXTAMP_VOLUME_DEFAULT1,
    VER1_AUD_VOLUME_LEVEL_DEFAULT1
};
...
AUDIO_CUSTOM_EXTRA_PARAM_STRUCT dual_mic_custom_default1 =
{
    DEFAULT_SPEECH_DUAL_MIC_ABF_PARA1,
    DEFAULT_SPEECH_DUAL_MIC_ABFWB_PARA1
};
