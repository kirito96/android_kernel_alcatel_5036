...
//	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //#Tune_TP_AvMoveToGamutDist
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062); //#REG_0TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052 = TRUE in MSM6800 //reg 027A
   ...
   S5K5CAGX_write_cmos_sensor(0x0F12, 0x0600);   
	...
	//S5K5CAGX_write_cmos_sensor(0x0F12, 0x2eb0);  //#REG_0TC_CCFG_usMinOut4KHzRate
        ...
        S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);  //0052 //#REG_1TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052 = TRUE in MSM6800 //reg 027A                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);  //#REG_0TC_CCFG_PVIMask 
...
UINT32 S5K5CAGXGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	pSensorResolution->SensorVideoWidth=S5K5CAGX_IMAGE_SENSOR_PV_WIDTH;
	pSensorResolution->SensorVideoHeight=S5K5CAGX_IMAGE_SENSOR_PV_HEIGHT;
	return ERROR_NONE;
