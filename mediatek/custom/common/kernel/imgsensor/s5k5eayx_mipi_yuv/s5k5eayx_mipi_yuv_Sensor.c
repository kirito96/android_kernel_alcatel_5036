...
// GAS Alpha Table    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3300);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
	
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3400);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
	
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x3900);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4000);
...
//==================================================================================    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1000);          //af_search_usSingleAfFlags,  Double peak , Fine search enable,          
...
// Continuous AF    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x5050);//af_refocus_usFlUpLow      //5050
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8080);//af_refocus_usFlLcUpLow  //8080
...
//AE Target    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0042);    
...
// AWB Convergence Speed    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0002);     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0001);     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0174);     //00074
...
//         param_start    awbb_IndoorGrZones_m_BGrid     S5K5EAYX_write_cmos_sensor(0x0F12, 0x0C00);    // 70003CD2 
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0392);	//0392);    //awbb_IndoorGrZones_m_BGrid[0]    0432
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0450);	//0450);    //awbb_IndoorGrZones_m_BGrid[1]    044A
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0354);	//0354);    //awbb_IndoorGrZones_m_BGrid[2]    0432
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x049E);	//049E);    //awbb_IndoorGrZones_m_BGrid[3]    0418
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0322);	//0322);    //awbb_IndoorGrZones_m_BGrid[4]    03FC
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0484);	//0484);    //awbb_IndoorGrZones_m_BGrid[5]    03D6
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0302);	//030A);    //awbb_IndoorGrZones_m_BGrid[6]    036E
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0446);	//0446);    //awbb_IndoorGrZones_m_BGrid[7]    034C
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02E2);	//02E2);    //awbb_IndoorGrZones_m_BGrid[8]    0308
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x041E);	//042E);    //awbb_IndoorGrZones_m_BGrid[9]    02EA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02BE);	//02BE);    //awbb_IndoorGrZones_m_BGrid[10]   02E0
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03F6);	//0400);    //awbb_IndoorGrZones_m_BGrid[11]   02CA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x029C);	//029C);    //awbb_IndoorGrZones_m_BGrid[12]   02C0
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03D0);	//03D2);    //awbb_IndoorGrZones_m_BGrid[13]   02B0
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x027A);	//027A);    //awbb_IndoorGrZones_m_BGrid[14]   029E
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x03A8);	//03A6);    //awbb_IndoorGrZones_m_BGrid[15]   0286
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0262);	//0262);    //awbb_IndoorGrZones_m_BGrid[16]   026A
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0382);	//0382);    //awbb_IndoorGrZones_m_BGrid[17]   0250
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0250);	//0250);    //awbb_IndoorGrZones_m_BGrid[18]   023E
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0318);	//0318);    //awbb_IndoorGrZones_m_BGrid[19]   0232
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0230);	//0236);    //awbb_IndoorGrZones_m_BGrid[20]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02F4);	//02F4);    //awbb_IndoorGrZones_m_BGrid[21]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0212);	//0212);    //awbb_IndoorGrZones_m_BGrid[22]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x02AC);	//02AC);    //awbb_IndoorGrZones_m_BGrid[23]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01FE);	//01FE);    //awbb_IndoorGrZones_m_BGrid[24]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0296);	//0296);    //awbb_IndoorGrZones_m_BGrid[25]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01EE);	//01F0);    //awbb_IndoorGrZones_m_BGrid[26]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0288);	//0288);    //awbb_IndoorGrZones_m_BGrid[27]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01E0);	//01E0);    //awbb_IndoorGrZones_m_BGrid[28]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x026C);	//0274);    //awbb_IndoorGrZones_m_BGrid[29]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01DA);	//01D2);    //awbb_IndoorGrZones_m_BGrid[30]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x025C);	//026E);    //awbb_IndoorGrZones_m_BGrid[31]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F0);	//01C6);    //awbb_IndoorGrZones_m_BGrid[32]
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x023A);	//0258);    //awbb_IndoorGrZones_m_BGrid[33]
...
//         param_start    awbb_IndoorGrZones_ZInfo_m_GridSz    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFB45);    // 70003D2C 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0011);   //awbb_IndoorGrZones_ZInfo_m_GridSz[0] 
...
//         param_start    awbb_IndoorGrZones_m_Boffs    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00CA);    //awbb_IndoorGrZones_m_Boffs[0]  
...
//==================================================================================
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF33);    //TVAR_wbt_pBaseCcms[21]              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C0);    //TVAR_wbt_pBaseCcms[22]              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF3F);    //TVAR_wbt_pBaseCcms[23]              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000F);    //TVAR_wbt_pBaseCcms[24]              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFFB);    //TVAR_wbt_pBaseCcms[25]              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C4);    //TVAR_wbt_pBaseCcms[26]              
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01EA);    //TVAR_wbt_pBaseCcms[30]              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7B);    //TVAR_wbt_pBaseCcms[31]              
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B1);    //TVAR_wbt_pBaseCcms[32]              
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C7);    //TVAR_wbt_pBaseCcms[54] // CW     /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD6);    //TVAR_wbt_pBaseCcms[55]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000A);    //TVAR_wbt_pBaseCcms[56]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEF1);    //TVAR_wbt_pBaseCcms[57]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x014E);    //TVAR_wbt_pBaseCcms[58]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF18);    //TVAR_wbt_pBaseCcms[59]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE6);    //TVAR_wbt_pBaseCcms[60]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFDD);    //TVAR_wbt_pBaseCcms[61]           /TVA
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01B2);    //TVAR_wbt_pBaseCcms[62]           /TVA
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C7);    //TVAR_wbt_pBaseCcms[72] // D50  
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD6);    //TVAR_wbt_pBaseCcms[73]         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000A);    //TVAR_wbt_pBaseCcms[74]         
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01C7);    //TVAR_wbt_pBaseCcms[90] // D65    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFD6);    //TVAR_wbt_pBaseCcms[91]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000A);    //TVAR_wbt_pBaseCcms[92]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF25);    //TVAR_wbt_pBaseCcms[93]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x019E);    //TVAR_wbt_pBaseCcms[94]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF6D);    //TVAR_wbt_pBaseCcms[95]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0022);    //TVAR_wbt_pBaseCcms[96]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFC7);    //TVAR_wbt_pBaseCcms[97]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x019D);    //TVAR_wbt_pBaseCcms[98]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x00C2);    //TVAR_wbt_pBaseCcms[99]           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x009A);    //TVAR_wbt_pBaseCcms[100]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFEFD);    //TVAR_wbt_pBaseCcms[101]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01F3);    //TVAR_wbt_pBaseCcms[102]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF7C);    //TVAR_wbt_pBaseCcms[103]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01A6);    //TVAR_wbt_pBaseCcms[104]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFF06);    //TVAR_wbt_pBaseCcms[105]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01BA);    //TVAR_wbt_pBaseCcms[106]          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0108);    //TVAR_wbt_pBaseCcms[107]          
...
//         AFIT 0      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0010);  //AFIT16_CONTRAST                                                                                      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8020);  //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                 
...
//         AFIT 1     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0010);    //AFIT16_CONTRAST                                                                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0009);    //AFIT16_SATURATION                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
...
//AFIT 2    
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000E);    //AFIT16_SATURATION                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0050);    //AFIT16_EE_iFlatBoundary                                                                             
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0510);    //AFIT8_EE_iReduceNoiseRatio [7:0] AFIT8_EE_iFlatSpan [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x180C);    //AFIT8_EE_iMSharpenLow [7:0] AFIT8_EE_iMSharpenHigh [15:8]                                           
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1410);    //AFIT8_EE_iWSharpenPosLow [7:0] AFIT8_EE_iWSharpenPosHigh [15:8]                                     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0178);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4636);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]
 
 //AFIT 3    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0028);    //AFIT16_CONTRAST                                                                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x000D);    //AFIT16_SATURATION                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0050);    //AFIT16_EE_iFlatBoundary                                                                             
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0030);    //AFIT16_Yuvemix_mNegRanges_0                                                                         
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0020);    //AFIT8_Dmsc_iMonochrom [7:0] AFIT8_Dmsc_iGRDenoiseVal [15:8]                                         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_Dmsc_iGBDenoiseVal [7:0] AFIT8_Dmsc_iEdgeDesatThrLow [15:8]                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1E00);    //AFIT8_Dmsc_iEdgeDesatThrHigh [7:0] AFIT8_Dmsc_iEdgeDesat [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_Dmsc_iEdgeDesatLimit [7:0] AFIT8_Dmsc_iNearGrayDesat [15:8]                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xE119);    //AFIT8_Postdmsc_iLowBright [7:0] AFIT8_Postdmsc_iHighBright [15:8]                                   
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1C1F);    //AFIT8_Yuviirnr_iUVNRStrengthL [7:0] AFIT8_Yuviirnr_iUVNRStrengthH [15:8]                            
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8080);    //AFIT8_byr_gras_iShadingPower [7:0] AFIT8_RGBGamma2_iLinearity [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x802E);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x4E01);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0181);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                 
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x463A);    //AFIT8_EE_iLowSharpPower_Bin [7:0] AFIT8_EE_iHighSharpPower_Bin [15:8]
 
  //AFIT 4    
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_BRIGHTNESS                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0028);    //AFIT16_CONTRAST                                                                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xFFE0);    //AFIT16_SATURATION                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_SHARP_BLUR                                                                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT16_GLAMOUR                                                                                      
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1E14);    //AFIT8_EE_iMSharpenLow [7:0] AFIT8_EE_iMSharpenHigh [15:8]                                           
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0101);    //AFIT8_EE_iFlatMean [7:0] AFIT8_EE_iFlatOffset [15:8]                                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_EE_iMShThLow [7:0] AFIT8_EE_iMShThHigh [15:8]                                                 
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x2623);    //AFIT8_EE_iWSharpenPosLow [7:0] AFIT8_EE_iWSharpenPosHigh [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x2619);    //AFIT8_EE_iWSharpenNegLow [7:0] AFIT8_EE_iWSharpenNegHigh [15:8]                                     
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0020);    //AFIT8_Dmsc_iMonochrom [7:0] AFIT8_Dmsc_iGRDenoiseVal [15:8]                                         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_Dmsc_iGBDenoiseVal [7:0] AFIT8_Dmsc_iEdgeDesatThrLow [15:8]                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1400);    //AFIT8_Dmsc_iEdgeDesatThrHigh [7:0] AFIT8_Dmsc_iEdgeDesat [15:8]                                     
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x0000);    //AFIT8_Dmsc_iEdgeDesatLimit [7:0] AFIT8_Dmsc_iNearGrayDesat [15:8]                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0xE119);    //AFIT8_Postdmsc_iLowBright [7:0] AFIT8_Postdmsc_iHighBright [15:8]                                   
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x7D0D);    //AFIT8_Postdmsc_iLowSat [7:0] AFIT8_Postdmsc_iHighSat [15:8]                                         
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x1E10);    //AFIT8_Postdmsc_iBCoeff [7:0] AFIT8_Postdmsc_iGCoeff [15:8]                                          
    ...
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x802E);    //AFIT8_RGBGamma2_iDarkReduce [7:0] AFIT8_ccm_oscar_iSaturation [15:8]                                
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x8000);    //AFIT8_RGB2YUV_iYOffset [7:0] AFIT8_RGB2YUV_iRGBGain [15:8]                                          
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x5801);    //AFIT8_Dspcl_nClustLevel_H [7:0] AFIT8_EE_iLowSharpPower [15:8]                                      
    S5K5EAYX_write_cmos_sensor(0x0F12, 0x01A0);    //AFIT8_EE_iHighSharpPower [7:0] AFIT8_Dspcl_nClustLevel_H_Bin [15:8]                                 
...
UINT32 S5K5EAYXOpen(void)
{
   kal_uint16 sensor_id=0;
	...
	if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_A2, VOL_2800,"S5K5EAYX"))
	{
...
UINT32 S5K5EAYXClose(void)
{
	...
	if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_A2,"S5K5EAYX"))
	{
		printk("[CAMERA SENSOR AF] Fail to enable analog power\n");
		return -EIO;
	}
