 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_HI253_YUV)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "960x540",      "1280x720",      "1280x768",/*zhao.li@tcl 13.5.27 add 1280x768 for Bug 459062*/
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("320x240"), 
            ITEM_AS_VALUES_(
                "176x144",      "320x240",     "480x320",      "640x480",      "800x480", /*zhao.li@tcl 13.5.27 add 800x480 for Bug 459062*/
                "864x480",      "1280x720"
            )
        ), 
    )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::CAPTURE_MODE_CONTINUOUS_SHOT, //zhao.li@tcl 13.5.27 add continuous shot for Bug 459062 
            )
        ), 
    )
#endif
