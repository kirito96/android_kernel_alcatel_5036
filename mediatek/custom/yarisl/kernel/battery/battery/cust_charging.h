...
#define RECHARGING_VOLTAGE      4110    //mingquan.lai modify for YarisL
#define RECHARGING_HIGH_TEMP_VOLTAGE   4000  //mingquan.lai add for YarisL
...
//mingquan.lai disable to support 4.20V YarisL battery
