...
//	unsigned char barcode[64];// add by zhoujinggao for P115 build error 
// pr 650022
// [REG]After writing BT/WIFI/CU, BT/WIFI/CU are blank in MMI test, OK in Teleweb and NOK in Settings
	RESERVED_S reserved;
