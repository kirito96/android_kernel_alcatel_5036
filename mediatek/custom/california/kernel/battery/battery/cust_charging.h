...
#define MAX_CHARGE_TEMPERATURE  55   //mingquan.lai set to 55 according to company standard 20130716
...
#define RECHARGING_VOLTAGE      4270    //mingquan.lai modify for HIGH_BATTERY_VOLTAGE 4.35V
#define RECHARGING_HIGH_TEMP_VOLTAGE   4050  //mingquan.lai add for HIGH_BATTERY_VOLTAGE 4.35V
...
#define BATTERY_AVERAGE_SIZE 	12     //mingquan.lai set BATTERY_AVERAGE_SIZE 12 to update battery info quicker

/* charger error check */
#define BAT_LOW_TEMP_PROTECT_ENABLE         // stop charging if temp < MIN_CHARGE_TEMPERATURE  mingquan.lai enable low temperature protection
...
//mingquan.lai modify to support 4.35V battery
