...
/*mingquan.lai add the temp for high temp charge*/
#define BATTERY_OVER_RECOVERY_CHARGING_TEMP 50
#define BATTERY_LOW_RECOVERY_CHARGING_TEMP 2
/*mingquan.lai add end*/
