...
CUSTOM_HAL_IMGSENSOR = ov5645_mipi_yuv s5k5eayx_mipi_yuv ov7690_yuv
...
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR= s5k5eayx_mipi_yuv
...
#mingquan.lai remove compass 20130419
...
CUSTOM_KERNEL_IMGSENSOR = ov5645_mipi_yuv s5k5eayx_mipi_yuv ov7690_yuv
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR= s5k5eayx_mipi_yuv
...
CUSTOM_KERNEL_TOUCHPANEL = ft5316 GT9XX
...
CUSTOM_LK_LCM = otm8009a_6572_dsi_cmd ili9806e_6572_dsi_vdo
...
# PR 443730 wenba.shao@tcl.com do not support wma begin
#MTK_ASF_PLAYBACK_SUPPORT=yes
MTK_ASF_PLAYBACK_SUPPORT=no
# PR 443730 wenba.shao@tcl.com do not support wma end
...
# support dual talk
MTK_DT_SUPPORT=no
# For MTK's dual mic configuration. #legen modify
...
# Enable JRD preloader reset to brom for usbdl.When "MTK_SEC_USBDL = ATTR_SUSBDL_ENABLE",this should be yes
...
# modified ed by xiaobo.he 2013-08-15 for PR505993 begin
# Stop PDP request after Clear Codes 33 & 29.
MTK_SPECIFIC_SM_CAUSE=yes
#modified ed by xiaobo.he 2013-08-15 for PR505993 end
...
CUSTOM_KERNEL_LCM = otm8009a_6572_dsi_cmd ili9806e_6572_dsi_vdo
...
MTK_VIDEO_FORCE_SEEK_WO_I=yes

MTK_NFC_OMAAC_SUPPORT=no

MTK_NFC_OMAAC_GEMALTO=no

# JRD MMITEST build Macro
JRD_BUILD_MMITEST = no

#add by jch for board detect
JRD_CALIFORNIA_BORAD = yes

#add by qiangbo.ni for orange sw distinguish from california common branch
JRD_ORANGE_SW = no

#add by jch for IPO ADB debug mingquan.lai disable IPO ADB debug
IPO_ADB_DEBUG_SUPORT = no

#add by jing.shen for choose XTV, 0 for not support ATV OR DTV, 1 for support ATV, 2 for support DTV
JRD_XTV_SUPPORT = 0

#add by jch for recovery usb storage suport
